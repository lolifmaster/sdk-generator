...
class AskYoDa:
    ...
    def update_project(self, project_id: str, data: PatchedAskYodaProjectUpdateRequest) -> requests.Response:
        return self._make_authenticated_request("PATCH", f"/aiproducts/askyoda/v2/{project_id}/update_project", json=data)
    ...
    def update_language(self, project_id: str, source_lang: str, target_lang: str, data: PatchedUniversalTranslatorCreatetRequest) -> requests.Response:
        return self._make_authenticated_request("PATCH", f"/aiproducts/translathor/{project_id}?source_lang={source_lang}&target_lang={target_lang}", json=data)

    def delete_language(self, project_id: str, source_lang: str, target_lang: str) -> requests.Response:
        return self._make_authenticated_request("DELETE", f"/aiproducts/translathor/{project_id}?source_lang={source_lang}&target_lang={target_lang}")
    ...
    def doc_parser_launch_call(self, project_id: str, data: DocParserCallParametersRequest) -> requests.Response:
        return self._make_authenticated_request("POST", f"/aiproducts/x_merge/doc_parser/{project_id}/launch_call", json=data)


if __name__ == "__main__":
    client = AskYoDa("https://api.edenai.run/v2", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiZjJhODdiMTUtMTk0MC00YTE3LTljYzQtN2E1ZWVjZDQ4ZGJkIiwidHlwZSI6ImFwaV90b2tlbiJ9.ChywjC-I1Ksp7KeHi1aASB5Oys1fRPY1AtDwhL0AZrc")
