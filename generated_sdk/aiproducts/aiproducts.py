...
class EdenAiClient:
    ...
    def update_language(self, project_id: str, source_lang: str, target_lang: str,
                        data: PatchedUniversalTranslatorCreatetRequest) -> requests.Response:
    ...
    def translate_by_project_name(self, project_name: str, data: UniversalTranslatorCallRequest) -> requests.Response:
        return self._make_authenticated_request("POST", f"/aiproducts/translathor/translate/{project_name}", json=data)
    ...
    def list_doc_parser_projects(self) -> requests.Response:
        return self._make_authenticated_request("GET", "/aiproducts/x_merge/doc_parser/")
    ...
    def retrieve_doc_parser_project(self, project_id: str) -> requests.Response:
        return self._make_authenticated_request("GET", f"/aiproducts/x_merge/doc_parser/{project_id}")
