...
class TestEdenAiClient(unittest.TestCase):
    ...
    def test_list_projects(self, mock_request):
        ...
        mock_request.assert_called_once_with('GET', 'https://api.edenai.run/v2/aiproducts/', headers={'Authorization': 'Bearer test_api_key'}, params={'project_type': 'test_project_type'})
    ...
    def test_retrieve_project(self, mock_request):
        ...
        self.assertEqual(response.status_code, 200)
        mock_request.assert_called_once_with('GET', 'https://api.edenai.run/v2/aiproducts/test_project_id', headers={'Authorization': 'Bearer test_api_key'})
