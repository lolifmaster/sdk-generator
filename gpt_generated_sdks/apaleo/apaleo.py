...
class ApaleoInventorySDK:
    ...
    def _make_authenticated_request(
        self, method, url, headers=None, params=None, json=None
    ):
    ...
    def Property_listGet(
        self,
        status: list[str] = None,
        includeArchived: bool = None,
        countryCode: list[str] = None,
        pageNumber: int = 1,
        pageSize: int = None,
    ...
    def Property_getById(
        self, id: str, languages: list[str] = None, expand: list[str] = None
    ) -> requests.Response:
        url = f"{self.base_url}/inventory/v1/properties/{id}"
        params = {"languages": languages, "expand": expand}
    ...
    def PropertyActions_cloneProperty(
        self, id: str, Idempotency_Key: str = None
    ) -> requests.Response:
    ...
    def Unit_updateUnitsAttributes(
        self, unitIds: list[str], data: dict
    ) -> requests.Response:
    ...
    def Unit_listUnits(
        ...
        unitGroupIds: list[str] = None,
        unitAttributeIds: list[str] = None,
        isOccupied: bool = None,
        maintenanceType: str = None,
        condition: str = None,
        textSearch: str = None,
        pageNumber: int = 1,
        pageSize: int = None,
    ...
    def Unit_create(
        self, Idempotency_Key: str, data: CreateUnitModel
    ) -> requests.Response:
        url = f"{self.base_url}/inventory/v1/units"
        headers = {"Idempotency-Key": Idempotency_Key}
        return self._make_authenticated_request("POST", url, headers=headers, json=data)
    ...
    def Unit_bulkCreateUnits(
        self, Idempotency_Key: str, data: BulkCreateUnitsModel
    ) -> requests.Response:
    ...
    def UnitAttribute_listAttributes(
        self, pageNumber: int = 1, pageSize: int = None
    ) -> requests.Response:
        url = f"{self.base_url}/inventory/v1/unit-attributes"
        params = {"pageNumber": pageNumber, "pageSize": pageSize}
        return self._make_authenticated_request("GET", url, params=params)

    def UnitAttribute_createNewAttribute(
        self, Idempotency_Key: str, data: CreateUnitAttributeDefinitionModel
    ) -> requests.Response:
        url = f"{self.base_url}/inventory/v1/unit-attributes"
        headers = {"Idempotency-Key": Idempotency_Key}
        return self._make_authenticated_request("POST", url, headers=headers, json=data)

    def UnitGroup_createNewGroup(
        self, Idempotency_Key: str, data: CreateUnitGroupModel
    ) -> requests.Response:
        url = f"{self.base_url}/inventory/v1/unit-groups"
        headers = {"Idempotency-Key": Idempotency_Key}
        return self._make_authenticated_request("POST", url, headers=headers, json=data)

    def UnitGroup_getAll(
        self,
        propertyId: str = None,
        unitGroupTypes: list[str] = None,
        pageNumber: int = 1,
        pageSize: int = None,
        expand: list[str] = None,
    ) -> requests.Response:
